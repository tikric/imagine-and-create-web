...
export const modules: Module[] = [
  ...
  },
  {
    ...
    number: 28,
    title: "TikTok Shop Masterclass: Vendas, Live e Creator Affiliates",
    tagline: "Catálogo, Shoppable Video, Live Shopping e programa de afiliados criadores",
    level: "Profissional",
    duration: "3h",
    methodology: "Masterclass operacional do TikTok Shop para vendedores de impressão 3D. Conteúdo detalhado das aulas será publicado na próxima atualização — estrutura espelha o módulo Shopee.",
    objective: "Vender no TikTok Shop combinando vídeos shoppable, lives e exército de afiliados criadores, com logística e pós-venda profissionais.",
    lessons: [
      L(1, "tiktok-shop-em-breve", "TikTok Shop — Conteúdo em produção", "3h",
        ["Seller Center TikTok", "Shoppable Video", "Live Shopping", "Creator Affiliates", "Logística"], {
          theory: [
            "Este módulo será expandido na próxima atualização com o mesmo padrão do Módulo 25 (Shopee): 7 aulas detalhadas cobrindo loja, anúncios, gestão, marketing, NF, logística e pós-venda — adaptadas à mecânica do TikTok Shop.",
          ],
          goldenRule: "Conteúdo orgânico viral + Live Shopping diário + 100+ afiliados criadores é a fórmula de explosão de vendas no TikTok Shop.",
        }),
    ],
  },
  {

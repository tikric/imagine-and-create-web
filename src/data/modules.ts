...
import mod8Img84 from "@/assets/orca/modulo8-img84.jpg.asset.json";
import mod8Img85 from "@/assets/orca/modulo8-img85.jpg.asset.json";
import mod8Img86 from "@/assets/orca/modulo8-img86.jpg.asset.json";
import mod8Img87 from "@/assets/orca/modulo8-img87.jpg.asset.json";
import mod8Img88 from "@/assets/orca/modulo8-img88.jpg.asset.json";
        ...
        ["Suporte de carga", "Dobradiça articulada", "Engrenagem mecânica", "Tolerâncias"], {
          ...
          paramDetails: [
            ...
            },
            {
              ...
              image: { src: mod8Img84.url, alt: "Tela do OrcaSlicer com Checklist Funcional de Geometria (1. Identificar requisitos mecânicos, 2. Mapear vetores de força, 3. Escolher padrão de infill) e peça impressa com setas vermelhas indicando vetores de carga", caption: "Antes de escolher folga, parede ou infill da dobradiça, rode o Checklist Funcional de Geometria: (1) identificar requisitos mecânicos — tração, compressão, fadiga cíclica no pino; (2) mapear vetores de força ativos — as setas vermelhas sobre a peça mostram onde a carga entra e sai (eixo do pino, base, abas); (3) escolher padrão de infill adequado para distribuir essas forças (Gyroid 25-30% para cargas multi-axiais). A peça em primeiro plano mostra exatamente esse mapeamento de vetores aplicado a um suporte articulado — é esse diagrama que decide se +0.15mm de folga vai bastar ou se o problema real é orientação e adesão Z." },
            ...
            },
            {
              ...
              image: { src: mod8Img87.url, alt: "Engrenagem PLA com suporte interfacial em PVA solúvel ao lado, parcialmente dissolvido em água; tela do OrcaSlicer com painel 'Interfaces com Materiais Especiais' (PVA, distância Z do topo 0.0mm, contaminação 0.01%) e mapas térmicos de bico e fluxo", caption: "Para engrenagem com dentes finos e furos passantes, suporte tradicional marca a superfície de engate — solução: interface em material solúvel. O painel 'Interfaces com Materiais Especiais' mostra a receita: material de interface PVA (solúvel em água) ou PETG para peças em PLA; distância Z do topo 0.0mm (contato total → superfícies inferiores perfeitas, sem marcas no flanco do dente); volume de purga (flushing) otimizado para manter contaminação cruzada em 0,01%. À direita, a mesma engrenagem em PLA preto liberada do suporte branco por dissolução em água — flancos lisos, prontos para engrenar sem retrabalho. Para Nylon-CF a regra é a mesma: separe o material de contato do material estrutural." },
            ...
            },
            {
              ...
              image: { src: mod8Img89.url, alt: "Tela do OrcaSlicer com tabela 'Diagnósticos de Acabamento em Inclinações' (empenamento, linhas ásperas, quebra do suporte) e peça impressa com inclinação de 60° destacada por lupa", caption: "Quick reference de diagnóstico que fecha as 3 receitas funcionais: sintoma → solução em inclinações típicas dessas peças. Empenamento (bordas viradas para cima) → ventilação 100%; linhas ásperas sob o suporte → reduzir espaçamento da linha de interface; quebra do suporte durante a impressão → ativar jangada (raft) ou aba (brim). A peça em primeiro plano (rampa a 60°) é exatamente o cenário que aparece em suportes de parede em L, abas de dobradiça e cubos de engrenagem — o mesmo trio que esta aula entrega. Use esta tabela quando a receita base falhar no primeiro teste." },
        ...
        ["Modo Vaso Espiral", "Seam Painting", "Ironing", "Tree Organic", "Acabamento premium"], {
          ...
          paramDetails: [
            ...
            },
            {
              ...
              image: { src: mod8Img86.url, alt: "Painel 'Matriz de Separação Z e XY' do OrcaSlicer (Distância Z Superior 0.2mm PLA padrão, Distância Z Inferior 0.2mm, Distância XY do Suporte 0.5mm) com dois cilindros impressos: à esquerda com Tree Organic, à direita com superfície limpa após remoção", caption: "Por que o busto sai sem marca de suporte: a Matriz de Separação Z e XY define a 'folga invisível' entre o suporte Tree Organic e a superfície curva do queixo, nariz e ombros. Distância Z Superior 0.2mm (PLA padrão) garante remoção fácil sem fusão; Distância Z Inferior 0.2mm protege superfícies de base; Distância XY do Suporte 0.5mm evita que o suporte funda na parede lateral do rosto. À direita, cilindro com superfície externa intacta após remoção — exatamente o resultado esperado em busto decorativo. O lembrete embaixo é direto: Z = 0.0mm funde permanentemente — em peça estética, é defeito irrecuperável." },
            ...
            },
            {
              ...
              image: { src: mod8Img88.url, alt: "Painel 'Otimização de Suporte em Árvore' do OrcaSlicer (Diâmetro do Tronco 4.0mm, Ângulo dos Ramos 45°, Densidade dos Ramos 0%) com peça orgânica suspensa em Tree Support colorido por mapa de estresse", caption: "Receita Tree Organic para luminária translúcida com paredes finas e overhangs largos: Diâmetro do Tronco 4.0mm dá estabilidade estrutural ao suporte sem virar bloco; Ângulo dos Ramos 45° previne colapso durante a impressão (acima disso, o ramo tomba); Densidade dos Ramos 0% (oco com parede única) economiza filamento e tempo — fundamental quando a peça é decorativa e o suporte é descarte puro. O mapa de calor à direita mostra onde os ramos absorvem estresse durante a impressão (vermelho) — exatamente os pontos onde o Tree Organic protege o overhang sem encostar na parede translúcida que vai filtrar a luz." },
            ...
            },
            {
              ...
              image: { src: mod8Img85.url, alt: "Guia de Sintonia da Camada de Interface do Suporte em OrcaSlicer com fluxo 'Ajustar Configurações → Imprimir Amostra → Remover e Avaliar', tabela de configurações (densidade 80-100%, grelha concentrada, 0.8mm) e gráfico comparativo de remoção e acabamento", caption: "Guia de sintonia da camada de interface — fecha a aula de estéticos porque é o que decide se a superfície da luminária sai lisa o suficiente para difundir luz uniformemente: Densidade da Interface 80-100% (camada densa que separa o suporte da peça sem furos visíveis), Padrão Grelha Concentrada e Espessura 0,8mm. O comparativo à direita mostra ganho real da Grelha Concentrada vs Padrão Padrão em Facilidade de Remoção, Qualidade de Superfície e Integridade da Peça — todas as três métricas que separam uma luminária de vitrine de uma com listras visíveis na luz. Ciclo: Ajustar → Imprimir Amostra → Remover e Avaliar antes de rodar o lote final." },

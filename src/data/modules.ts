...
export const modules: Module[] = [
...

  {
    ...
    lessons: [
      L(1, "anisotropia-forcas", "Anisotropia e Forças", "35min",
        ["Anisotropia", "Direção de carga", "Eixos X/Y/Z"], {
          theory: [
            "Anisotropia é a propriedade de um material apresentar diferentes comportamentos mecânicos em diferentes direções. Na impressão FDM, a peça é muito mais forte em X/Y (paralela às camadas) do que em Z (perpendicular).",
            "A direção Z é mais fraca porque as camadas são unidas apenas por adesão térmica — não há continuidade molecular. A ligação é mais fraca que o próprio material.",
            "Analogia: como uma madeira compensada — forte na direção das fibras, fraca perpendicular a elas. A impressão 3D tem 'fibras' horizontais.",
            "Peça orientada corretamente pode suportar até 5-6× mais carga que a mesma peça orientada incorretamente. A diferença é a direção das camadas em relação à força.",
          ],
          integrations: [
            { module: "Módulo 1 (Interface)", text: "Use 'Place on Face' para deitar a peça na direção que maximiza resistência à carga real." },
            { module: "Módulo 13 (Tolerâncias)", text: "Anisotropia afeta tolerância: encaixes em XY são previsíveis; encaixes em Z variam mais." },
          ],
          params: [
            { param: "Eixo X/Y (Horizontal)", value: "Resistência Máxima", action: "Forte, contínuo — como fibra de madeira" },
            { param: "Eixo Z (Vertical)", value: "Resistência Mínima", action: "Frágil, descontinuidade — cola entre fibras" },
            { param: "Layer Height (estrutural)", value: "0.12-0.16mm", action: "Camadas finas = mais superfície de adesão = mais resistência Z" },
            { param: "Temperatura (estrutural)", value: "+5°C", action: "Mais quente = melhor adesão entre camadas" },
            { param: "Velocidade (estrutural)", value: "-20%", action: "Mais lenta = melhor adesão entre camadas" },
          ],
          ...
          errors: [
            ...
            { error: "Fratura entre camadas", solution: "Aumentar temperatura +5°C, reduzir velocidade 20%, usar camadas 0.12-0.16mm" },
            { error: "Falha em áreas específicas", solution: "Aumentar número de paredes (4-6) na região" },
          ],
          ...
          exercise: [
            ...
            "Posicione com camadas paralelas à força (use Place on Face)",
            "Configure 4-6 paredes + Gyroid 25-40%",
            "Imprima 2 versões (correta e incorreta), quebre na mão para sentir a diferença",
          ],
          deepDive: [
            "Tabela de decisão: Tração → camadas paralelas à força; Compressão → camadas perpendiculares à força; Flexão → camadas paralelas à flexão; Torção → camadas a 45°; Carga multidirecional → Gyroid.",
            "Material e adesão Z: PETG tem excelente adesão (difícil quebrar), PLA boa, ABS média (warping reduz), Nylon excelente.",
            "Exemplo prático — Gancho de parede: força de tração vertical → orientação deitada, camadas horizontais, força alinhada com fibras = carga máxima.",
          ],
        }),
      L(2, "orientacao-tensoes", "Orientação e Tensões", "35min",
        ["Orientação", "Tração/compressão/flexão/torção", "Place on Face"], {
          theory: [
            "A orientação da peça na mesa determina como as camadas serão depositadas e como as forças serão distribuídas. Cada orientação cria um padrão de tensões diferente.",
            "Orientação Horizontal (deitada): camadas paralelas à mesa, máxima resistência à tração e flexão, melhor acabamento no topo, pode exigir suportes para overhangs.",
            "Orientação Vertical (em pé): camadas empilhadas, boa resistência à compressão mas pior à tração/flexão, menos suportes necessários.",
            "Orientação Diagonal (45°): compromisso, distribuição equilibrada de forças, ideal para torção e cargas multidirecionais.",
          ],
          integrations: [
            { module: "Módulo 1 (Interface)", text: "Place on Face automatiza orientação básica; Rotacionar (R) ajusta manualmente para casos críticos." },
            { module: "Módulo 19 (Suportes)", text: "Boa orientação reduz drasticamente suportes — bônus de design e tempo." },
          ],
          params: [
            { param: "Tensão de Tração", value: "Camadas paralelas à força", action: "Máxima resistência à tração (ex: gancho)" },
            { param: "Tensão de Compressão", value: "Camadas perpendiculares", action: "Boa resistência à compressão (ex: coluna)" },
            { param: "Tensão de Flexão", value: "Camadas paralelas à flexão", action: "Máxima resistência à flexão (ex: viga)" },
            { param: "Tensão de Torção", value: "Camadas a 45°", action: "Distribuição uniforme (ex: eixo de engrenagem)" },
            { param: "Tensão de Cisalhamento", value: "Camadas perpendiculares ao cisalhamento", action: "Máxima resistência ao corte" },
          ],
          goldenRule: "A melhor orientação alinha as camadas com a força principal. Use Place on Face como ponto de partida, mas ajuste manualmente quando a resistência for crítica.",
          errors: [
            { error: "Peça quebra sob carga", solution: "Reorientar para alinhar camadas com a força principal" },
            { error: "Suportes excessivos", solution: "Rotacionar para minimizar overhangs (Tree Organic se inevitável)" },
            { error: "Superfície ruim onde precisa ser lisa", solution: "Avaliar compromisso — orientação afeta resistência E acabamento" },
            { error: "Tempo longo por causa de suportes", solution: "Cortar peça (Cut) e orientar partes individualmente" },
          ],
          ...
          exercise: [
            ...
            "Pendure peso crescente até quebrar cada",
            "Documente qual orientação aguentou mais carga",
          ],
          deepDive: [
            "Tabela de decisão por peça: Gancho/suporte → deitado (tração); Coluna/pilar → em pé (compressão); Viga/alavanca → deitado (flexão); Engrenagem → deitado (torção uniforme); Tampa/caixa → deitado (acabamento); Busto/figura → 45° (equilíbrio).",
            "Ferramentas do OrcaSlicer: Place on Face (face plana na mesa), Rotacionar R (controle manual), Cut (dividir peça grande para orientar partes), Tree Organic (suportes mínimos quando inevitável).",
          ],
        }),
      L(3, "resistencia-estrutural", "Resistência Estrutural — Paredes vs Infill", "35min",
        ["Wall loops", "Gyroid/Cubic", "Receita 4 paredes + 25%"], {
          theory: [
            ...
            "Paredes são contínuas (linhas externas/internas sem quebra) e absorvem a maior parte da carga. Infill é descontínuo (muda de direção) e contribui menos para a resistência.",
            "4 paredes são mais importantes que 40% de infill. Aumentar paredes em vez de densidade economiza tempo E material — duplo ganho.",
            "Gyroid é o melhor padrão genérico: células 3D contínuas, sem cruzamentos na mesma camada, distribuição isotrópica de forças.",
          ],
          integrations: [
            { module: "Módulo 18 (Infill)", text: "Gyroid e Cubic para distribuição isotrópica de tensões em peças estruturais." },
            { module: "Módulo 7 (Otimização)", text: "Aumentar paredes em vez de densidade economiza material e tempo." },
          ],
          params: [
            { param: "Wall Loops (padrão)", value: "4", action: "Ponto ideal: 80% da resistência com 20% do material" },
            { param: "Wall Loops (estrutural)", value: "5-6", action: "Quando resistência é crítica (suportes, ferramentas)" },
            { param: "Infill Pattern", value: "Gyroid", action: "Isotrópico, sem nós de tensão — padrão estrutural" },
            { param: "Infill Density (geral)", value: "15-25%", action: "Uso geral recomendado" },
            { param: "Infill Density (estrutural)", value: "25-40%", action: "Peças que sofrem cargas reais" },
            { param: "Top/Bottom Layers", value: "4-6 camadas", action: "Fecha superfície sem pinholing" },
            { param: "Layer Height (estrutural)", value: "0.12-0.16mm", action: "Mais adesão entre camadas = mais resistência Z" },
          ],
          goldenRule: "A resistência vem principalmente das paredes. 4 paredes + 20-25% Gyroid superam 2 paredes + 40% de infill. Priorize paredes, não infill.",
          errors: [
            { error: "Peça quebra mesmo com 80% de infill", solution: "Reduza infill para 25% e suba paredes para 6 — vai ficar mais rígido" },
            { error: "Peça pesada, lenta e ainda fraca", solution: "Trocar estratégia: mais paredes, menos infill, padrão Gyroid" },
            { error: "Quebra na junção entre paredes e infill", solution: "Ativar 'Detect overhang wall', revisar temperatura e Flow" },
            { error: "Deformação sob carga", solution: "Trocar material (PLA → PETG → Nylon) conforme exigência" },
          ],
          finance: "Receita '4 paredes + 25% Gyroid' usa 30-40% menos material que receita 'infill alto' equivalente em rigidez.",
          exercise: [
            "Imprima 3 cubos: (a) 2 paredes + 60% infill, (b) 4 paredes + 25% Gyroid, (c) 6 paredes + 10% Gyroid",
            "Pese cada um e aplique flexão na mão até deformar",
            "Calcule rigidez por grama — paredes+Gyroid vence",
            "Imprima suporte real com receita estrutural e teste sob carga",
          ],
          deepDive: [
            "Tabela de decisão: Protótipo → 2 paredes + Grid 15% + 0.20mm + PLA; Uso geral → 4 paredes + Gyroid 20% + 0.20mm + PLA+; Estrutural → 5 paredes + Gyroid 30% + 0.16mm + PETG; Alta carga → 6 paredes + Gyroid 40% + 0.12mm + Nylon.",
            "Por que camadas finas (0.12mm) são mais resistentes em Z: mais superfície de contato, melhor adesão térmica, distribuição mais uniforme de cargas.",
            "Exemplo prático — Suporte de motor 5kg em PETG: 6 paredes, Gyroid 35%, 0.16mm, 245°C, 50 mm/s paredes externas → suporte resistente sem deformação.",
          ],
          checklist: [
    ...
    lessons: [
      L(1, "otimizacao-conceitos", "Otimização Extrema — Conceitos Gerais", "25min",
        ["Eficiência material e temporal", "Métricas min/g e custo/peça", "Identificação de oportunidades"], {
          theory: [
            "Otimização extrema é o conjunto de técnicas para reduzir tempo e filamento sem comprometer resistência e qualidade. O objetivo é o equilíbrio entre eficiência e desempenho.",
            "Quatro princípios: eficiência material (menos plástico onde não importa), temporal (rápido onde a qualidade não é crítica), estrutural (resistência onde é necessária) e energética (menos kWh por peça).",
            "Métricas-chave: tempo por grama (min/g), custo por peça, resistência por grama e produtividade (peças/hora). Uma peça otimizada pode custar 50% menos e produzir 150% mais por dia.",
            "Analogia do carro: nem devagar gastando combustível, nem rápido gastando tempo — a otimização é a velocidade ideal entre os dois extremos.",
          ],
          integrations: [
            ...
            { module: "Módulo 9 (Comercial)", text: "Eficiência se traduz direto em margem: 50% menos custo por peça = dobro de lucro na mesma venda." },
          ],
          params: [
      ...
      L(2, "reduzir-tempo-material", "Reduzir Tempo e Material sem Perder Rigidez", "35min",
        ["Lightning Infill", "Bico 0.6mm/0.8mm", "Adaptive Layer Height"], {
          theory: [
            "Lightning Infill cria 'raízes' que sustentam apenas as superfícies superiores, deixando o interior vazio. Economiza até 60% de filamento e 30% de tempo — ideal para decorativos com paredes grossas.",
            "Bico 0.6mm dobra o fluxo do 0.4mm; bico 0.8mm quadruplica. Tempo de impressão cai de 4h para 2h (0.6mm) ou 1h (0.8mm) na mesma peça — paredes ficam mais grossas e resistentes.",
            "Adaptive Layer Height analisa a geometria e reduz altura em curvas/detalhes, aumenta em áreas planas. Mesma qualidade percebida com 25% menos tempo.",
            "Combine: bico 0.6 + Lightning 10% + Adaptive Layers transforma peça de 6h em 2h30 com perda mínima de qualidade aparente. Para estruturais: bico 0.6 + Gyroid 20% + 4 paredes mantém resistência com −30% de tempo.",
          ],
          integrations: [
            { module: "Módulo 18 (Infill)", text: "Lightning só para decorativos — em peças funcionais use Gyroid ou Cubic." },
          ...
          params: [
            ...
            { param: "Diâmetro do Bico", value: "0.6mm (eficiência) / 0.8mm (volume)", action: "Mais fluxo, menos passadas" },
            { param: "Largura da Linha", value: "0.60-0.65mm (bico 0.6)", action: "Acompanhar o bico após troca" },
            { param: "Altura da Camada", value: "0.24-0.32mm (bico 0.6)", action: "Aproveitar a vazão extra" },
          ...
          finance: "Caso real: 100 organizadores de mesa. Perfil otimizado (bico 0.6, Lightning 10%, 2 paredes) = 45min/peça e 80g vs 1h30 e 150g do perfil padrão → custo por peça cai pela metade.",
          exercise: [

...
export const modules: Module[] = [
  ...
  {
    id: "tour-visual-orcaslicer",
    number: 25,
    title: "Tour Visual OrcaSlicer 2.4 — Painel Esquerdo",
    tagline: "Cada tela, cada ferramenta da barra esquerda, dominada",
    level: "Intermediário",
    duration: "2h 30min",
    methodology: "Walkthrough visual capturando cada seção real do painel esquerdo do OrcaSlicer 2.4 em Modo Desenvolvedor. Para cada tela, identificamos a aba ativa, a ferramenta destacada e os parâmetros relevantes — você acompanha com o software aberto.",
    objective: "Mapear visualmente as abas Qualidade, Resistência, Velocidade do painel esquerdo do OrcaSlicer e identificar, com precisão, qual ferramenta está sendo ajustada em cada tela.",
    lessons: [
      L(1, "tela-11-qualidade-camada-largura-costura", "Tela 01 — Qualidade: Altura da camada, Largura da linha e Costura", "15min",
      ...
      L(2, "tela-12-qualidade-precisao-alisamento", "Tela 02 — Qualidade: Precisão, Alisamento (Ironing) e Compensações", "15min",
      ...
      L(3, "tela-13-resistencia-gerador-paredes", "Tela 03 — Resistência: Gerador de Paredes (Classic vs Arachne) e Superfícies", "15min",
      ...
      L(4, "tela-14-resistencia-ponte-saliencias", "Tela 04 — Resistência: Pontes e Saliências (Overhangs)", "12min",
      ...
      L(5, "tela-21-resistencia-cascas-preenchimento", "Tela 05 — Resistência: Voltas da Parede, Cascas e início do Infill", "15min",
      ...
      L(6, "tela-22-resistencia-padroes-infill", "Tela 06 — Resistência: Padrões e Direção do Infill", "15min",
      ...
      L(7, "tela-23-resistencia-avancado", "Tela 07 — Resistência: Avançado (camadas sólidas, bridge angle, espessura)", "12min",
      ...
      L(8, "tela-31-velocidade-primeira-camada", "Tela 08 — Velocidade: Primeira Camada e Outras Camadas", "15min",
      ...
      L(9, "tela-32-velocidade-saliencias-aceleracao", "Tela 09 — Velocidade: Saliências, Travel e Aceleração", "15min",
        ["Aba Velocidade", "Velocidade em saliências", "Travel", "Aceleração"], {
          screens: [{
            src: "tela_32",
            tela: "Tela 32",
            panel: "Painel Esquerdo › aba VELOCIDADE (meio)",
            tool: "Seções visíveis: Velocidade em saliências · Velocidade de deslocamento · Aceleração",
            caption: "Tabela de redução em saliências (10%/25%/50%/75%) e parâmetros de aceleração por tipo de linha.",
          }],
          theory: [
            "Velocidade em saliências é tabelada por % de overhang: 0 mm/s (10%), 50 mm/s (25%), 30 mm/s (50%), 10 mm/s (75%) — quanto maior o overhang, mais lento.",
            "Ponte: 30 mm/s externo, 150% interno.",
            "Deslocamento (Travel) = 300 mm/s — alto para minimizar stringing.",
            "Aceleração: Impressão normal 6000, Parede externa 2000, Parede interna 4000, Ponte 5000, Infill esparso 5000, Superfície superior 2000, Deslocamento 10000 mm/s².",
            "Acelerações altas em parede externa causam GHOSTING — reduza para 500–1000 mm/s² em peças visuais.",
          ],
          params: [
            { param: "Velocidade ponte externa", value: "30 mm/s", action: "Lento = ponte limpa" },
            { param: "Travel", value: "300 mm/s", action: "Minimiza stringing" },
            { param: "Aceleração parede externa", value: "500–1000 mm/s²", action: "REDUZIR de 2000 p/ matar ghosting" },
            { param: "Aceleração infill", value: "5000 mm/s²", action: "Alto = ganho de tempo" },
            { param: "Aceleração travel", value: "10000 mm/s²", action: "Muito alto p/ movimentos aéreos" },
          ],
          goldenRule: "Aceleração baixa (500–1000 mm/s²) em parede externa elimina ghosting. Reserve aceleração alta para infill e travel.",
        }),
      L(10, "tela-33-velocidade-jerk-extrusao", "Tela 10 — Velocidade: Jerk(XY), Decel e Suavização de Extrusão", "12min",
      ...
      L(12, "tela-42-suporte-avancado-interface", "Tela 12 — Suporte: Avançado, Z Gap, Interface e Padrão", "15min",
      ...
      L(13, "tela-43-suporte-arvore", "Tela 13 — Suporte: Árvore (Tree) — ramos, ângulos e densidade", "12min",
      ...
      L(14, "tela-51-multimaterial-torre-preparo", "Tela 14 — Multimaterial: Torre de Preparo (Wipe Tower)", "15min",
      ...
      L(15, "tela-52-multimaterial-filamento-purga", "Tela 15 — Multimaterial: Filamento por Recurso e Opções de Purga", "12min",
      ...
      L(16, "tela-61-outros-saia-borda-vaso", "Tela 16 — Outros: Saia (Skirt), Borda (Brim) e Modo Vaso", "15min",
      ...
      L(17, "tela-62-outros-textura-difusa-gcode", "Tela 17 — Outros: Textura Difusa (Fuzzy Skin) e Opções de G-code", "12min",

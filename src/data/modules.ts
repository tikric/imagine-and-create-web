...
export const modules: Module[] = [
  ...
  },
  {
    ...
    number: 26,
    title: "Mercado Livre Masterclass: Vendas, Mercado Ads e Reputação",
    tagline: "Catálogo, MELI+, Mercado Envios Full, Mercado Ads e reputação verde",
    level: "Profissional",
    duration: "3h",
    methodology: "Masterclass operacional do Mercado Livre para vendedores de impressão 3D. Conteúdo detalhado das aulas será publicado na próxima atualização — estrutura espelha o módulo Shopee.",
    objective: "Operar o Mercado Livre com reputação verde, Mercado Envios Full, Mercado Ads otimizado e estratégia de catálogo para escalar peças impressas em 3D.",
    lessons: [
      L(1, "mercado-livre-em-breve", "Mercado Livre — Conteúdo em produção", "3h",
        ["Conta e reputação", "Anúncio Clássico vs Premium", "Mercado Envios Full", "Mercado Ads", "Pós-venda"], {
          theory: [
            "Este módulo será expandido na próxima atualização com o mesmo padrão do Módulo 25 (Shopee): 7 aulas detalhadas cobrindo loja, anúncios, gestão, marketing, NF, logística e pós-venda — adaptadas à mecânica do Mercado Livre.",
          ],
          goldenRule: "Reputação verde + Mercado Envios Full + anúncio Premium nos top SKUs é a fórmula base do vendedor profissional no Mercado Livre.",
        }),
    ],
  },
  {

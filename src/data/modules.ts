...
export const modules: Module[] = [
  ...
  },
  {
    ...
    number: 27,
    title: "Amazon Masterclass: Vendas, Amazon Ads e Buy Box",
    tagline: "Seller Central, FBA vs FBM, Amazon Ads (Sponsored Products) e Buy Box",
    level: "Profissional",
    duration: "3h",
    methodology: "Masterclass operacional da Amazon Brasil para vendedores de impressão 3D. Conteúdo detalhado das aulas será publicado na próxima atualização — estrutura espelha o módulo Shopee.",
    objective: "Vender na Amazon com Buy Box, ACoS controlado, FBA quando faz sentido e listings otimizados em A9.",
    lessons: [
      L(1, "amazon-em-breve", "Amazon — Conteúdo em produção", "3h",
        ["Seller Central", "FBA vs FBM", "Sponsored Products", "Buy Box", "Reviews"], {
          theory: [
            "Este módulo será expandido na próxima atualização com o mesmo padrão do Módulo 25 (Shopee): 7 aulas detalhadas cobrindo loja, anúncios, gestão, marketing, NF, logística e pós-venda — adaptadas à mecânica da Amazon Brasil.",
          ],
          goldenRule: "Listing otimizado em A9 + Sponsored Products com ACoS < 25% + Buy Box é o tripé do vendedor lucrativo na Amazon.",
        }),
    ],
  },
  {

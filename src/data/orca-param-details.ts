...
export const orcaParamDetails: Record<string, OrcaParamDetail[]> = {
  ...
  "tela-52-multimaterial-filamento-purga": [
    {
      name: "Filamento para Recursos (Conceito Geral)",
      value: "Padrão (todos os recursos)",
      whatIs: "Sistema que permite atribuir filamentos específicos a diferentes partes da peça (paredes externas, internas, infill, topo, base, torre). Possibilita peças híbridas com cores ou materiais combinados em uma única impressão.",
    ...
    {
      name: "Paredes externas (Outer Walls)",
      value: "Padrão",
      whatIs: "Define o filamento usado para a parede mais externa da peça — a superfície visível que define cor, textura e acabamento.",
    ...
    {
      name: "Paredes internas (Inner Walls)",
      value: "Padrão",
      whatIs: "Define o filamento usado para as paredes internas, que dão estrutura à peça mas não são visíveis externamente.",
    ...
    {
      name: "Preenchimento (Infill)",
      value: "Padrão",
      whatIs: "Define o filamento usado para o preenchimento interno (infill) da peça — totalmente invisível na peça finalizada.",
    ...
    {
      name: "Preenchimento sólido (Solid Infill)",
      value: "Padrão",
      whatIs: "Define o filamento usado para o infill denso (100%) que aparece em camadas de transição — abaixo do topo e acima da base.",
    ...
    {
      name: "Superfície superior (Top Surface)",
      value: "Padrão",
      whatIs: "Define o filamento usado especificamente para a camada superior da peça — a face de cima visível.",
    ...
    {
      name: "Superfície inferior (Bottom Surface)",
      value: "Padrão",
      whatIs: "Define o filamento usado para a camada inferior da peça — a base que toca a mesa.",
    ...
    {
      name: "Torre de limpeza (Prime Tower)",
      value: "Padrão",
      whatIs: "Define o filamento usado para imprimir a torre de purga em si — geralmente o material que será mais descartado.",
    ...
    {
      name: "Ativar Prevenção de vazamento (Enable Ooze Prevention)",
      value: "Desativado (padrão)",
      whatIs: "Liga ou desliga o sistema que controla onde e quando o filamento é purgado durante trocas multimaterial, evitando que o bico inativo 'babe' filamento na peça.",
    ...
    {
      name: "Opções de purga (Purge Options)",
      value: "Torre de limpeza (padrão)",
      whatIs: "Define ONDE o filamento purgado vai durante as trocas — torre dedicada, infill da peça ou suportes.",
    ...
    {
      name: "Purgar no preenchimento dos objetos (Purge into Infill)",
      value: "Desativado",
      whatIs: "Reaproveita o filamento purgado para imprimir o infill da própria peça. Em vez de jogar fora na torre, vira estrutura interna útil.",
    ...
    {
      name: "Purgar nos suportes dos objetos (Purge into Supports)",
      value: "Ativado",
      whatIs: "Reaproveita o filamento purgado para imprimir os suportes. Como o suporte será removido e descartado, é o destino perfeito para a purga.",
    ...
    {
      name: "Usar intertravamento de viga (Beam Interlocking)",
      value: "Desativado",
      whatIs: "Recurso avançado que intercala mecanicamente camadas de filamentos diferentes na fronteira entre regiões, criando uma conexão física tipo 'dente de engrenagem'.",
    ...
    {
      name: "Cascas de interface (Interface Shells)",
      value: "Desativado",
      whatIs: "Adiciona camadas extras (cascas) na interface entre regiões de filamentos diferentes para reforçar a adesão entre eles.",
    ...
    {
      name: "Largura máxima de uma região segmentada",
      value: "5-10mm (padrão)",
      whatIs: "Define o tamanho máximo de uma área segmentada para o sistema de intertravamento. Áreas maiores são divididas em segmentos menores para criar mais pontos de ancoragem.",
    ...
    {
      name: "Profundidade de intertravamento de uma região segmentada",
      value: "1-2mm (padrão)",
      whatIs: "Define a profundidade (penetração) das estruturas de intertravamento entre regiões de filamentos diferentes — quanto cada material 'invade' o outro.",
  ...
  "tela-61-outros-saia-borda-vaso": [
    {
      name: "Voltas da saia (Skirt Loops)",
      value: "1-3 voltas",
      whatIs: "Número de linhas que a saia desenha ao redor da peça sem tocá-la. A saia purga o bico, ativa o fluxo e dá tempo para verificar a primeira camada antes da peça começar.",
      whyAdjust: "0 voltas = começa direto na peça (risco de subextrusão inicial). 3 voltas = bico estável e fluxo perfeito quando começa.",
      influences: "Qualidade do início da peça, perda de filamento, tempo extra (segundos).",
      generates: "Sem skirt: primeira linha pode falhar. Com 2 voltas: começo limpo. Com 5: purga total em materiais difíceis (TPU, Nylon).",
      optionsTable: {
        headers: ["Voltas", "Efeito", "Quando Usar"],
        rows: [
          ["0", "Sem saia", "Tempo crítico, mesa cheia"],
          ["1-2", "Padrão recomendado", "Uso geral"],
          ["3-5", "Purga completa", "Peças grandes, TPU, Nylon"],
        ],
      },
      goldenRule: "Use 1-3 voltas. Para peças críticas ou materiais difíceis, sempre 3+.",
    },
    {
      name: "Tipo de saia (Skirt Type)",
      value: "Padrão",
      whatIs: "Define o posicionamento da saia em relação à peça — ao redor de cada objeto ou apenas ao redor do contorno externo total.",
      whyAdjust: "Com múltiplas peças, 'Outer' desenha uma saia única externa em vez de uma por peça, economizando tempo.",
      influences: "Tempo de purga, uso de filamento na saia.",
      generates: "10 peças pequenas com saia 'Padrão' = 10 saias. Com 'Outer' = 1 saia contornando tudo.",
      optionsTable: {
        headers: ["Tipo", "Efeito", "Quando Usar"],
        rows: [
          ["Padrão", "Saia por peça", "Uma peça ou peças separadas"],
          ["Outer", "Saia contornando tudo", "Múltiplas peças próximas"],
        ],
      },
      goldenRule: "Uma peça: Padrão. Várias peças na mesa: Outer.",
    },
    {
      name: "Comprimento mínimo de extrusão da saia",
      value: "Padrão (~250mm)",
      whatIs: "Comprimento mínimo de filamento que a saia deve extrudar, mesmo que isso exija voltas extras. Garante purga adequada do bico.",
      whyAdjust: "Em peças pequenas, 1 volta pode ser muito curta para purgar. Esse valor força mais voltas até atingir o mínimo.",
      influences: "Purga real do bico, número efetivo de voltas.",
      generates: "Peça pequena (20mm) + 1 volta: só 80mm de purga (insuficiente). Mínimo 250mm: força 3-4 voltas automaticamente.",
      optionsTable: {
        headers: ["Valor", "Efeito", "Quando Usar"],
        rows: [
          ["100mm", "Purga mínima", "Peças grandes"],
          ["250mm", "Padrão equilibrado", "Uso geral"],
          ["500mm+", "Purga extensiva", "Após troca de filamento, materiais difíceis"],
        ],
      },
      goldenRule: "Mantenha padrão. Aumente se vir subextrusão no início mesmo com 3 voltas.",
    },
    {
      name: "Distância da saia (Skirt Distance)",
      value: "5-10mm",
      whatIs: "Espaço horizontal entre a saia e a peça. Define quão longe a saia fica da impressão real.",
      whyAdjust: "Muito perto pode interferir; muito longe desperdiça espaço. Quando usado como draft shield, deve estar bem próximo.",
      influences: "Espaço ocupado na mesa, proteção contra correntes de ar.",
      generates: "5mm: saia próxima, mesa otimizada. 20mm: muito espaço perdido. 2mm com draft shield: proteção térmica eficaz.",
      optionsTable: {
        headers: ["Distância", "Efeito", "Quando Usar"],
        rows: [
          ["2-5mm", "Bem próxima", "Draft shield ativo"],
          ["5-10mm", "Padrão", "Uso geral"],
          ["10-20mm", "Distante", "Peças grandes, evitar interferência"],
        ],
      },
      goldenRule: "5-10mm cobre 95% dos casos. Reduza para 2mm se usar como escudo térmico.",
    },
    {
      name: "Ponto de partida da saia",
      value: "Padrão",
      whatIs: "Define onde a saia começa a ser impressa — automaticamente pelo fatiador ou em um ponto personalizado pelo usuário.",
      whyAdjust: "Útil para evitar que a saia comece em uma posição inconveniente (ex: sobre um clip da mesa).",
      influences: "Posição inicial do bico, possíveis colisões com obstáculos na mesa.",
      generates: "Padrão: Orca escolhe canto mais próximo. Personalizado: usuário define ponto seguro fora de clips/sensores.",
      optionsTable: {
        headers: ["Opção", "Efeito", "Quando Usar"],
        rows: [
          ["Padrão", "Fatiador decide", "Uso geral"],
          ["Personalizado", "Usuário define", "Mesa com obstáculos específicos"],
        ],
      },
      goldenRule: "Padrão funciona quase sempre. Personalize só se a mesa tem obstáculos.",
    },
    {
      name: "Velocidade da saia (Skirt Speed)",
      value: "30-50 mm/s",
      whatIs: "Velocidade de impressão das linhas da saia. Como a saia é purga/verificação, geralmente é mais lenta que a peça.",
      whyAdjust: "Lenta = mais tempo para você observar a primeira camada e ajustar Z se necessário. Rápida = economiza tempo.",
      influences: "Tempo de espera no início, qualidade de observação da primeira camada.",
      generates: "20 mm/s: você consegue ajustar baby step durante a saia. 80 mm/s: saia termina em segundos.",
      optionsTable: {
        headers: ["Velocidade", "Efeito", "Quando Usar"],
        rows: [
          ["20-30 mm/s", "Lenta, observável", "Verificação da primeira camada"],
          ["30-50 mm/s", "Padrão", "Uso geral"],
          ["50-80 mm/s", "Rápida", "Impressões em série, sem ajuste"],
        ],
      },
      goldenRule: "30 mm/s na primeira impressão de um modelo (para ajustar). 50+ depois que está calibrado.",
    },
    {
      name: "Altura da saia (Skirt Height)",
      value: "1 camada",
      whatIs: "Número de camadas que a saia tem. Normalmente 1, mas pode ser aumentada para criar um escudo térmico vertical.",
      whyAdjust: "Altura > 1 transforma a saia em uma parede que protege contra correntes de ar — útil para ABS/Nylon.",
      influences: "Função da saia (purga vs escudo), tempo extra, uso de filamento.",
      generates: "Altura 1: purga simples. Altura 10: parede de ~2mm que reduz warping em ABS. Altura toda a peça: draft shield completo.",
      optionsTable: {
        headers: ["Altura", "Efeito", "Quando Usar"],
        rows: [
          ["1", "Padrão purga", "Uso geral"],
          ["2-3", "Purga múltiplas camadas", "Materiais difíceis"],
          ["10+", "Escudo térmico", "ABS, Nylon, ambiente com correntes"],
        ],
      },
      goldenRule: "1 para purga. Aumente para 10+ apenas como draft shield em ABS/Nylon.",
    },
    {
      name: "Escudo de ar (Draft Shield)",
      value: "Desativado",
      whatIs: "Parede fina impressa em toda a altura da peça ao redor dela, formando uma barreira térmica contra correntes de ar que causam warping e delaminação.",
      whyAdjust: "ABS e Nylon contraem violentamente se resfriam de forma desigual. O escudo mantém o ar quente próximo à peça.",
      influences: "Estabilidade térmica, warping, tempo de impressão, uso de filamento.",
      generates: "ABS sem escudo + ventilador da sala = warping garantido. Com escudo = peça plana e íntegra.",
      optionsTable: {
        headers: ["Opção", "Efeito", "Quando Usar"],
        rows: [
          ["Desativado", "Sem proteção térmica", "PLA, PETG em ambiente fechado"],
          ["Ativado", "Parede protetora", "ABS, ASA, Nylon, PC"],
        ],
      },
      goldenRule: "Ative para ABS/Nylon/PC. Desative para PLA. Combine com câmara fechada quando possível.",
    },
    {
      name: "Tipo de borda (Brim Type)",
      value: "Auto",
      whatIs: "Define onde e como a borda (brim) é aplicada à peça. A borda é uma extensão da primeira camada que aumenta a área de contato com a mesa, prevenindo warping.",
      whyAdjust: "Diferentes tipos cobrem diferentes necessidades: só externa para visual, interna para ilhas com warping, em todos os lugares para máxima adesão.",
      influences: "Adesão à mesa, prevenção de warping, tempo de remoção, marca na base.",
      generates: "ABS sem brim = warp. Com brim externo 8mm = peça plana. Peça com furo interno empenando = brim interno resolve.",
      optionsTable: {
        headers: ["Tipo", "Efeito", "Quando Usar"],
        rows: [
          ["Auto", "Orca decide por formato", "Uso geral, deixe automático"],
          ["Externo", "Brim só por fora", "Visual, warping em paredes externas"],
          ["Interno", "Brim em furos", "Ilhas internas empenando"],
          ["Em todos", "Externo + interno", "Máxima adesão (ABS difícil)"],
          ["Nenhum", "Sem brim", "PLA com excelente adesão"],
        ],
      },
      goldenRule: "PLA: Auto/Nenhum. PETG: Externo. ABS/ASA: Externo 8-10mm ou 'Em todos'.",
    },
    {
      name: "Largura da borda (Brim Width)",
      value: "5-10mm",
      whatIs: "Extensão em milímetros que a borda se estende para fora da peça. Define a área extra de contato com a mesa.",
      whyAdjust: "Mais largo = mais adesão e mais anti-warping, mas mais material e mais trabalho para remover.",
      influences: "Força de adesão, prevenção de warping, esforço de remoção, marca na base.",
      generates: "Brim 3mm = adesão leve. Brim 10mm = ABS estável. Brim 15+mm = excessivo, difícil de remover.",
      optionsTable: {
        headers: ["Largura", "Efeito", "Quando Usar"],
        rows: [
          ["2-5mm", "Brim pequeno", "PLA, peças pequenas"],
          ["5-10mm", "Padrão", "Uso geral, PETG"],
          ["10-15mm", "Brim grande", "ABS, peças altas/finas"],
        ],
      },
      goldenRule: "PLA: 3-5mm. PETG: 5-8mm. ABS/ASA: 8-12mm. Peça alta e estreita: 12-15mm.",
    },
    {
      name: "Espaço entre a borda e objeto (Brim Object Gap)",
      value: "0-0.1mm",
      whatIs: "Folga horizontal entre o brim e a parede da peça. Define se o brim fica colado ou levemente separado.",
      whyAdjust: "0 = adesão máxima, mas remoção exige canivete. 0.1+ = remove com a mão, mas pode soltar antes da hora.",
      influences: "Facilidade de remoção, qualidade da base após remoção, segurança da adesão.",
      generates: "Gap 0: remoção com lâmina, base perfeita. Gap 0.15: solta com a mão, mas pode descolar durante impressão.",
      optionsTable: {
        headers: ["Espaço", "Efeito", "Quando Usar"],
        rows: [
          ["0-0.05mm", "Colado", "Máxima adesão (ABS)"],
          ["0.1mm", "Padrão", "Uso geral"],
          ["0.2-0.3mm", "Separado", "Remoção sem ferramenta (PLA estável)"],
        ],
      },
      goldenRule: "Padrão 0 ou 0.1mm. Aumente apenas se quiser remoção fácil sem ferramentas.",
    },
    {
      name: "Taxa de fluxo em borda (Brim Flow Ratio)",
      value: "100%",
      whatIs: "Multiplicador de extrusão aplicado especificamente à borda. Controla quanto plástico vai para o brim.",
      whyAdjust: "Aumentar = brim mais grosso e mais aderente. Diminuir = brim mais fino e fácil de remover.",
      influences: "Espessura do brim, força de adesão, facilidade de remoção.",
      generates: "95%: brim fino, descola fácil. 100%: padrão. 110%: brim grosso, adere muito (difícil remover).",
      optionsTable: {
        headers: ["Fluxo", "Efeito", "Quando Usar"],
        rows: [
          ["90-95%", "Brim fino", "Remoção fácil, PLA"],
          ["100%", "Padrão", "Uso geral"],
          ["105-110%", "Brim grosso", "Adesão máxima (ABS difícil)"],
        ],
      },
      goldenRule: "Mantenha 100%. Ajuste apenas se brim soltar (subir) ou for difícil demais de remover (baixar).",
    },
    {
      name: "Borda segue contorno compensado",
      value: "Ativado",
      whatIs: "Faz a borda seguir o contorno já compensado (com horizontal expansion) da peça em vez do contorno original do modelo.",
      whyAdjust: "Mantém a consistência dimensional do brim com a peça real impressa, evitando descasamentos.",
      influences: "Precisão dimensional, alinhamento do brim com a peça.",
      generates: "Ativado: brim alinhado perfeitamente com a peça compensada. Desativado: pode ter pequenos degraus na junção.",
      optionsTable: {
        headers: ["Opção", "Efeito", "Quando Usar"],
        rows: [
          ["Ativado", "Segue contorno compensado", "Uso geral (padrão)"],
          ["Desativado", "Segue contorno original", "Casos específicos de compatibilidade"],
        ],
      },
      goldenRule: "Mantenha ativado. Desative apenas se houver problema visível na junção brim-peça.",
    },
    {
      name: "Combinar bordas (Combine Brims)",
      value: "Ativado",
      whatIs: "Une as bordas de múltiplas peças próximas em uma única borda contínua quando elas se sobrepõem.",
      whyAdjust: "Economiza material, facilita a remoção (uma peça única em vez de várias) e melhora estabilidade do grupo.",
      influences: "Uso de filamento, facilidade de remoção, estabilidade de peças adjacentes.",
      generates: "5 peças próximas: brims separados = 5 trabalhos de remoção. Combinados = 1 estrutura unificada.",
      optionsTable: {
        headers: ["Opção", "Efeito", "Quando Usar"],
        rows: [
          ["Ativado", "Brims unificados", "Múltiplas peças próximas"],
          ["Desativado", "Brims individuais", "Peças bem separadas"],
        ],
      },
      goldenRule: "Sempre ativado. Sem desvantagem prática quando as peças estão próximas.",
    },
    {
      name: "Modo de Fatiamento (Slicing Mode)",
      value: "Padrão (Regular)",
      whatIs: "Define o algoritmo principal de fatiamento — modo regular ou modos especiais como vaso espiral, que mudam radicalmente a geometria gerada.",
      whyAdjust: "Vaso espiral remove costuras e cria peças contínuas, mas só funciona em geometrias específicas (peças ocas, parede única).",
      influences: "Estrutura completa da peça, presença de infill/topo, tipo de geometria suportada.",
      generates: "Modo Regular: peça normal com camadas, infill, topo. Vaso Espiral: parede única helicoidal sem costura.",
      optionsTable: {
        headers: ["Modo", "Efeito", "Quando Usar"],
        rows: [
          ["Regular", "Fatiamento normal", "99% dos casos"],
          ["Vaso Espiral", "Espiral contínua", "Vasos, copos, abajures"],
        ],
      },
      goldenRule: "Padrão para tudo. Vaso espiral só para peças decorativas ocas de parede única.",
    },
    {
      name: "Sequência de impressão (Print Sequence)",
      value: "Por camada",
      whatIs: "Define se a impressora imprime todas as peças camada por camada ('Por camada') ou termina uma peça inteira antes de começar a próxima ('Por objeto').",
      whyAdjust: "'Por objeto' permite recuperar peças se uma falhar, mas exige altura limite (bico pode bater nas outras peças impressas).",
      influences: "Risco de falha em lote, tempo total, restrições de altura, possibilidade de remover peças durante impressão.",
      generates: "Por camada: 10 peças sobem juntas. Por objeto: peça 1 termina, depois peça 2 etc. Risco: bico pode colidir.",
      optionsTable: {
        headers: ["Sequência", "Efeito", "Quando Usar"],
        rows: [
          ["Por camada", "Todas juntas", "Padrão, uso geral"],
          ["Por objeto", "Uma por vez", "Múltiplas peças, recuperação possível"],
        ],
      },
      goldenRule: "Por camada para tudo. Por objeto só se conhecer as restrições de altura do bico/gantry.",
    },
    {
      name: "Ordem intra-camada (Intra-layer Order)",
      value: "Padrão",
      whatIs: "Define a ordem em que diferentes objetos/regiões são impressos dentro de uma mesma camada — automática ou personalizada pelo usuário.",
      whyAdjust: "Em casos específicos (multimaterial, otimização de trajetos), o usuário pode querer forçar uma ordem específica.",
      influences: "Trajetos de viagem, tempo de impressão, qualidade em multimaterial.",
      generates: "Padrão: Orca otimiza caminhos. Personalizado: usuário força ordem específica (raro).",
      optionsTable: {
        headers: ["Ordem", "Efeito", "Quando Usar"],
        rows: [
          ["Padrão", "Fatiador otimiza", "Uso geral (sempre)"],
          ["Personalizado", "Usuário define", "Casos avançados específicos"],
        ],
      },
      goldenRule: "Mantenha padrão. Personalizar exige conhecimento profundo do que está fazendo.",
    },
    {
      name: "Vaso espiral (Spiral Vase)",
      value: "Ativar para vasos",
      whatIs: "Modo especial onde a peça é impressa como uma espiral helicoidal contínua — uma única parede que sobe sem interrupções, sem costuras Z, sem topo e sem infill.",
      whyAdjust: "Resultado mágico em peças decorativas: vasos sem costura visível, transição perfeita entre camadas, impressão até 4× mais rápida (só uma parede).",
      influences: "Aplicável apenas a vasos, copos, abajures, peças decorativas ocas de parede única.",
      generates: "Vaso 200mm: tempo ~1h vs 4h normal. Visual: sem costura vertical, perfeitamente liso, transições invisíveis.",
      optionsTable: {
        headers: ["Opção", "Efeito", "Quando Usar"],
        rows: [
          ["Ativado", "Espiral contínua", "Vasos, luminárias, copos decorativos"],
          ["Desativado", "Impressão normal", "Uso geral, peças funcionais"],
        ],
      },
      goldenRule: "Modo Vaso + filamento Silk + 1 parede + altura 0.3mm = vasos profissionais em 1h.",
    },
  ],
  ...
  "tela-62-outros-textura-difusa-gcode": [
    {
      name: "Fuzzy Skin (Conceito Geral)",
      value: "Somente pintada",
      whatIs: "Técnica que adiciona textura rugosa/felpuda à superfície externa, modificando a trajetória do bico com pequenas oscilações para criar superfície tipo 'lixa' ou 'feltro'. Disfarça imperfeições e cria acabamento premium tátil.",
      whyAdjust: "Combina estética (acabamento diferenciado), função (aderência em cabos), prática (esconde marcas de costura) e tátil (toque agradável).",
      influences: "Acabamento visual, aderência tátil, leve aumento de tempo e filamento (5-10%).",
      generates: "Cabo de ferramenta com Fuzzy: aderência instantânea, parece couro. Caixa decorativa: visual premium, sem linhas de camada visíveis.",
      optionsTable: {
        ...
        rows: [
          ...
          ["Figuras de ação", "Textura realista", "Miniaturas"],
        ],
      },
      goldenRule: "Use Fuzzy Skin para acabamento premium e para esconder imperfeições em peças visíveis.",
    },
    {
      name: "Ativar Fuzzy Skin",
      value: "Conforme necessidade",
      whatIs: "Interruptor principal que liga ou desliga a geração da textura difusa nas paredes externas. Define se toda a peça receberá textura, apenas regiões pintadas ou nenhuma.",
      whyAdjust: "Decide se a peça terá textura uniforme, seletiva ou nenhuma — afeta tempo e estética.",
      influences: "Aparência final, tempo de impressão (+5-10%), uso de filamento.",
      generates: "Ativado em toda peça: textura uniforme. Somente pintada: cabo texturizado, corpo liso. Desativado: peça normal lisa.",
      optionsTable: {
        headers: ["Opção", "Efeito", "Quando Usar"],
        rows: [
          ["Desativado", "Superfície lisa normal", "Uso geral, peças funcionais"],
          ["Contorno externo", "Textura em toda face externa", "Peças totalmente texturizadas"],
          ["Todas as paredes", "Externas + internas", "Efeito máximo (mais material)"],
          ["Somente pintada", "Apenas onde você pintou", "Controle cirúrgico (cabos)"],
        ],
      },
      goldenRule: "Prefira 'Somente pintada' + pintura nos cabos/empunhaduras — controle total sem perder tempo onde deve ser liso.",
    },
    {
      name: "Semente (Seed)",
      value: "0 (padrão)",
      whatIs: "Valor numérico que controla a aleatoriedade do padrão de ruído. Mudar a semente gera padrões de textura diferentes mantendo os mesmos parâmetros de intensidade.",
      whyAdjust: "Permite variar o aspecto da textura sem mudar densidade/profundidade. Útil para imprimir várias peças idênticas com texturas únicas.",
      influences: "Padrão visual específico da textura (não a intensidade).",
      generates: "Seed 0: padrão A. Seed 42: padrão B (mesma intensidade, distribuição diferente). 10 peças com seeds diferentes = 10 padrões únicos.",
      optionsTable: {
        headers: ["Valor", "Efeito", "Quando Usar"],
        rows: [
          ["0", "Padrão fixo", "Reprodutibilidade"],
          ["1-100", "Padrão alternativo", "Variar acabamento"],
          [">100", "Padrão mais orgânico", "Textura única por peça"],
        ],
      },
      goldenRule: "Use 0 para padrão consistente. Varie a semente quando quiser peças idênticas com texturas distintas.",
    },
    {
      name: "Deslocamento (Offset / Point Distance)",
      value: "0.3mm",
      whatIs: "Distância entre os pontos de oscilação do bico ao longo da parede. Controla a frequência/densidade da textura — quão próximos estão os 'dentes' da rugosidade.",
      whyAdjust: "Menor = textura mais fina e densa (lixa). Maior = textura mais espaçada e grosseira (ondulação).",
      influences: "Densidade visual da textura, granulometria, tempo de impressão.",
      generates: "0.2mm: textura fina tipo lixa. 0.5mm: textura média. 1mm: quase ondulações grossas.",
      optionsTable: {
        headers: ["Deslocamento", "Efeito", "Quando Usar"],
        rows: [
          ["0.1-0.2mm", "Textura sutil/fina", "Peças estéticas"],
          ["0.3mm", "Padrão equilibrado", "Uso geral"],
          ["0.4-0.6mm", "Textura pronunciada", "Aderência (cabos)"],
          ["0.8-1.0mm", "Textura grosseira", "Efeitos especiais"],
        ],
      },
      goldenRule: "0.3mm é o sweet spot. Aumente para mais textura, reduza para mais sutileza.",
    },
    {
      name: "Clássico (Classic Mode)",
      value: "Ativado",
      whatIs: "Ativa o algoritmo original de Fuzzy Skin baseado em ruído Perlin clássico, que gera oscilações naturais e orgânicas. Alternativa moderna pode usar algoritmos diferentes.",
      whyAdjust: "Clássico é mais previsível e consistente. Desativado abre opções para tipos de ruído experimentais.",
      influences: "Algoritmo de geração, consistência da textura.",
      generates: "Ativado: textura Perlin clássica (orgânica). Desativado: permite escolher entre Simplex, Voronoi, White Noise.",
      optionsTable: {
        headers: ["Opção", "Efeito", "Quando Usar"],
        rows: [
          ["Ativado", "Algoritmo Perlin clássico", "Recomendado, uso geral"],
          ["Desativado", "Algoritmos alternativos", "Testes experimentais"],
        ],
      },
      goldenRule: "Mantenha Clássico ativado para resultado consistente e previsível.",
    },
    {
      name: "Tipo de ruído da textura difusa",
      value: "Perlin",
      whatIs: "Define o algoritmo matemático que gera o padrão de ruído da textura. Cada tipo cria uma assinatura visual distinta.",
      whyAdjust: "Perlin é o padrão (natural/orgânico). Outros tipos criam efeitos específicos como padrões celulares (Voronoi) ou aleatoriedade total (White Noise).",
      influences: "Estilo visual da textura, padrão característico.",
      generates: "Perlin: ondulações orgânicas. Simplex: uniformidade suave. Voronoi: padrão celular tipo couro. White Noise: caos total.",
      optionsTable: {
        headers: ["Tipo", "Efeito", "Quando Usar"],
        rows: [
          ["Perlin", "Orgânico, natural", "Recomendado, uso geral"],
          ["Simplex", "Uniforme, suave", "Peças funcionais"],
          ["Voronoi", "Celular, tipo couro", "Efeitos decorativos"],
          ["White Noise", "Totalmente aleatório", "Acabamentos experimentais"],
        ],
      },
      goldenRule: "Perlin para a maioria. Experimente Voronoi em peças decorativas, Simplex em funcionais.",
    },
    {
      name: "Destruição da textura difusa (Destruction)",
      value: "0.3mm",
      whatIs: "Controla a intensidade das imperfeições/variações dentro da textura, criando efeito de desgaste ou envelhecimento. Adiciona uma segunda camada de aleatoriedade sobre o padrão base.",
      whyAdjust: "Valores maiores simulam superfícies desgastadas, envelhecidas ou erodidas — útil para props, miniaturas e peças com aparência 'usada'.",
      influences: "Realismo visual, aparência de envelhecimento, intensidade do desgaste simulado.",
      generates: "0.1mm: peça nova. 0.3mm: ligeira variação natural. 0.6mm: aparência desgastada. 0.8mm+: erosão extrema.",
      optionsTable: {
        headers: ["Valor", "Efeito", "Quando Usar"],
        rows: [
          ["0.1-0.2mm", "Desgaste sutil", "Peças novas/estéticas"],
          ["0.3mm", "Padrão", "Uso geral"],
          ["0.4-0.6mm", "Desgaste pronunciado", "Peças envelhecidas"],
          ["0.8mm+", "Erosão extrema", "Props, efeitos especiais"],
        ],
      },
      goldenRule: "0.3mm para realismo natural. Aumente para simular desgaste em props e miniaturas.",
    },
    {
      name: "Espessura da textura difusa (Thickness/Amplitude)",
      value: "0.3mm",
      whatIs: "Quanto a parede é deslocada para dentro e para fora pelo ruído — define a profundidade real da textura. É o parâmetro que mais afeta o impacto visual e tátil.",
      whyAdjust: "Maior = textura mais pronunciada e tátil. Menor = textura mais sutil. CUIDADO: amplitude > 50% da largura de linha pode comprometer a integridade da parede.",
      influences: "Profundidade tátil/visual, integridade estrutural da parede, uso de filamento.",
      generates: "0.2mm: textura sutil visível na luz. 0.4mm: textura claramente tátil. 0.6mm+: textura muito marcante (risco em parede fina).",
      optionsTable: {
        headers: ["Espessura", "Efeito", "Quando Usar"],
        rows: [
          ["0.1-0.2mm", "Superficial", "Peças estéticas, paredes finas"],
          ["0.3mm", "Padrão equilibrado", "Uso geral"],
          ["0.4-0.6mm", "Profunda, tátil", "Cabos, aderência"],
          ["0.8mm+", "Extrema (risco)", "Apenas paredes ≥ 3 perímetros"],
        ],
      },
      goldenRule: "Nunca ultrapasse 50% da largura de linha (linha 0.42mm = max 0.2mm). Acima disso, parede vira queijo suíço.",
    },
    {
      name: "Aplicar textura difusa à primeira camada",
      value: "Desativado (padrão)",
      whatIs: "Define se a textura também é aplicada na primeira camada da peça (que toca a mesa). Por padrão desativado para preservar adesão.",
      whyAdjust: "A primeira camada precisa de contato máximo com a mesa para adesão. Textura nela reduz contato e pode causar descolamento.",
      influences: "Adesão à mesa, uniformidade visual da textura, risco de falha de impressão.",
      generates: "Desativado: base lisa firme, paredes texturizadas (visual quase imperceptível). Ativado: peça uniformemente texturizada, mas risco de descolamento.",
      optionsTable: {
        headers: ["Opção", "Efeito", "Quando Usar"],
        rows: [
          ["Desativado", "Primeira camada lisa", "Recomendado (padrão)"],
          ["Ativado", "Textura na base também", "Peças onde a base é visível e adesão é confiável"],
        ],
      },
      goldenRule: "Desative para garantir adesão. Ative APENAS se a base for visível e você tiver mesa muito aderente.",
    },
    {

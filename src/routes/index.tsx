      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-20 pb-24 grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-16 items-center">
        <div>
          ...
          <div className="fade-up mt-10 flex flex-col sm:flex-row gap-4">
            ...
            <Link to="/calibracao" className="inline-flex items-center justify-center rounded-md border border-primary/40 bg-primary/10 px-7 py-3.5 text-sm font-medium text-primary hover:bg-primary/20 transition">
